  ...
  <div class="min-h-screen bg-white">
    <div class="relative mx-auto min-h-screen max-w-xl px-4 p-5">
      ...
      <div class="relative flex items-center justify-between">
        <!-- BACK -->
        <NuxtLink to="/" class="flex h-10 items-center justify-center">
      ...
      <form class="mt-4 space-y-2" @submit.prevent="onSubmit">
        ...
        <div>
          ...
          >
            ...
            <div class="mx-3 h-5 w-px bg-[#DCE8F3]"></div>
        ...
        <div class="flex items-center justify-between px-1 pt-2">
          <label
            class="flex cursor-pointer items-center gap-2 text-[12px] text-slate-500"
          >
            <span class="relative flex h-4.5 w-4.5 items-center justify-center">
              <input
                v-model="state.remember"
                type="checkbox"
                class="peer absolute h-4.5 w-4.5 cursor-pointer appearance-none rounded-[5px] border border-[#DCE8F3] bg-white transition-all checked:border-[#145DA0] checked:bg-[#145DA0]"
              />

              <UIcon
                name="i-heroicons-check"
                class="pointer-events-none relative z-10 h-3 w-3 scale-0 text-white transition-transform peer-checked:scale-100"
              />
            </span>
