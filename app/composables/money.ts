export const useMoney = () => {
  ...
  const toMoney = (number: number | string): string => {
    const num = Number(Number(number || 0).toFixed(3));
  ...
  const vnMiniMoney = (number: number | string): string | number => {
    ...
    if (num >= 1000 && num <= 999999)
      return `${financial(num / 1000, 0)} nghìn +`;
    if (num > 999999 && num <= 999999999)
      return `${financial(num / 1000000, 0)} triệu +`;
  ...
  const miniMoney = (number: number | string): string | number => {
    ...
    if (num > 999999999 && num <= 999999999999)
      return `${financial(num / 1000000000)}b`;
    if (num > 999999999999 && num <= 999999999999999)
      return `${financial(num / 1000000000000)}t`;
    if (num > 999999999999999 && num <= 999999999999999999)
      return `${financial(num / 1000000000000000)}q`;
    return 0;
  };
